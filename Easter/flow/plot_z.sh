...
gmt surface "tmp.dat" -G$grdf -I0.02/0.02 -T0.5 -R$WESN
#surface $etafile -G$grdeta -I2/2 -T1 -R$WESN
#surface $topofile -G$topogrd -I2/2 -T1 -R$WESN
gmt grdimage $grdf -Ba1f1WeSn -C${CPT} -Jm${scl} -K -R${WESN} -X3 -Y1 > $out21
