...
!-----------------------------------------------------------------------
! modified by Takuto MINAMI in order not to use geofem_util in geofem_tiger
      module partitioner
...
!### from geofem_util ######################  type local_mesh
...
!#####   from geofem_util ##################  type node_elem_grp
...
!########  from geofem_util ###################  type grp_data
