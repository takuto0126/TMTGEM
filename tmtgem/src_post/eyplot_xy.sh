...
bxyzfile="./exyz/exyz_xy2D"${1}".dat"
out21="./exyz/exyz_xy2D"${1}".ps"
#pos5file="../gebco/pos5.dat"
#topofile="../gebco/topo.xyz"
#polygonfile="../gebco/polygon2.dat"
#polygongmt="polygon2.gmt"
# get dt
if [ ${2} = 1 ]; then bcomp="ex" ; fi
if [ ${2} = 2 ]; then bcomp="ey" ; fi
if [ ${2} = 3 ]; then bcomp="ez" ; fi
...
open(1,file="tmp.dat")
do i=1,ntrik
 write(1,*) xy(1,i),xy(2,i),exyz(2,i)
end do
close(1)
...
grdtopo="topo.grd"
CPT="bz.cpt"
makecpt -Cpolar -T-1/1/0.05 -V > ${CPT}
...
18.8  12.8 25 0 4 CM ey
18.8  12.0 16 0 4 CM [mV/km]
EOF
#=========  plot end =======================
#rm ocaen.dat
