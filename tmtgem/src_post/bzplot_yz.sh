...
width=1500
WESN=-${width}/${width}/-500/1000
bxyzfile="./bxyz/bxyz_yz2D"${1}".dat"
out21="./bxyz/bxyz_yz2D"${1}".ps"
...
open(1,file="./bxyz/coord_yz2D.dat")
read(1,*) ntrik
...
open(1,file="tmp.dat")
do i=1,ntrik
 write(1,*) xyz(2,i),xyz(3,i),bxyz(3,i)
end do
close(1)
