...
subroutine PREPOBSCOEFF(em_mesh,l_line,obs_sites,ki_mesh,g_param)
use mesh_type
use line_type
use matrix
use obs_type
...
integer(4) :: iflag ! for PREPZOBS 2021.7.26
...
!cal coeffobs(1:2,1:3)
 CALL CALCOEFF_LINE(em_mesh,l_line,glist,obs_sites,g_param%iflagspherical)
