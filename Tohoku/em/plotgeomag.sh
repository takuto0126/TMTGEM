...
cat $inp | awk '{print($1,$2,$3)}' | gmt xyz2grd -G$grdf_x -I10/10  -R$WESN
cat $inp | awk '{print($1,$2,$4)}' | gmt xyz2grd -G$grdf_y -I10/10  -R$WESN
cat $inp | awk '{print($1,$2,$5)}' | gmt xyz2grd -G$grdf_z -I10/10  -R$WESN
...
EOF
gmt psscale -D15.5/6/10/0.3 -B2000 -C$CPT -O >> $out
