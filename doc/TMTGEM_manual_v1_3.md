...
$$∑_{j=1}^6[{[∫_{Ω_e}{(∇×w_i )⋅(∇×w_j )}dV]+\frac{3μσ_e}{2Δt} [∫_{Ω_e}[w_i⋅w_j dV]]} [[Al]_j ]_{n+2} ]=∑_(j=1)^6[\frac{1}{2Δt} [∫_{Ω_e}[w_i⋅w_j dV]](4[[Al]_j ]_(n+1)-[[Al]_j ]_n ) ]+μσ_e ∑_(m=1)^4[(∫_{Ω_e}[w_i λ_m dV])⋅[v×B_0 ]_m ] .⋅⋅⋅(15)$$
...
$$∑_{j=1}^6 [∫_{Ω_e}[{(\frac{1}{L} ∇'×\frac{1}{L} w_i' )⋅(\frac{1}{L} ∇'×\frac{1}{L} w_j')} L^3 dV'+\frac{3μσ_e}{2Δt} ∫_{Ω_e}[\frac{1}{L} w_i'⋅\frac{1}{L} [w']_j L^3 dV']]$$
