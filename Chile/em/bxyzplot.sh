...
grdtopo="topo.grd"
CPT="bz.cpt"
$GMT makecpt -Cpolar -T-5/5/0.05 > ${CPT}
...
$GMT psxy "$polygongmt" -JX$scl -R$WESN -L -K -O  -W1,black >> $out21

$GMT psxy "$pos5file" -JX$scl -R$WESN -K -O -W0.5,black >> $out21

$GMT grdcontour $grdtopo -A1000 -C1000 -L-8000/-1000 -W0.2,green -JX -K -O >> $out21

$GMT psscale -D15.5/6/10/0.3 -B2 -C$CPT -K -O >> $out21
scl2=17/15 ; range2=0/20/0/15

$GMT pstext -JX$scl2 -R$range2  -W0 -G255 -O <<EOF >> $out21
